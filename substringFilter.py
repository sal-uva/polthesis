...
def substringFilter(querystring='all', histogram = False, mintime = 0, maxtime = 0, stringintitle = False, inputtime = 'months', normalised = True, writetext = False, docsimilarity = False, wordclusters = False, similaritytype = None):
