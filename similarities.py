...
import pickle
import operator
from createHistogram import createCosineDistHisto
#import glove_python
...
def getTsneScatterPlot(model, plottitle='', plotname='', perplexity=10, minword=.03, highlightword=''):
	print('getting vocab')
	...
	pickle.dump(fig, open(r'word_embeddings/word2vec/tsne/mpl_tsnescatterplot_' + plotname + '.p', 'wb'))
	...
	#mpld3.show()
	#save to html
	mpld3.save_html(fig, 'word_embeddings/word2vec/tsne/mpl_tsnescatterplot_' + plotname + '.html')
	plt.savefig('word_embeddings/word2vec/tsne/mpl_tsnescatterplot_' + plotname + '.png', dpi=200)
